...
public class UpdateHandler extends BaseHandler<CallbackContext> {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        final ResourceModel responseModel = ResourceModel.builder()
                ...
                .createdAt(updateDefinitionResponse.createdAt() == null ? null : updateDefinitionResponse.createdAt().toString())
                .lastUpdatedAt(updateDefinitionResponse.lastUpdatedAt() == null ? null : updateDefinitionResponse.lastUpdatedAt().toString())
