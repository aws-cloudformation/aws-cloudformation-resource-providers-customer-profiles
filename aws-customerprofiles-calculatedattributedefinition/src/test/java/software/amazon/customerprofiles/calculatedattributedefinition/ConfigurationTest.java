...
public class ConfigurationTest {
    ...
    private static final String SCHEMA_FILE_NAME = "aws-customerprofiles-calculatedattributedefinition.json";
    ...
    public void testEmptyResourceTags() {
        final ResourceModel model = ResourceModel.builder().tags(ImmutableSet.of()).build();
        final Map<String, String> tags = configuration.resourceDefinedTags(model);
