...
public class DeleteHandlerTest {
    ...
    public void handleRequest_simpleSuccess() {
        ...
        final DeleteEventStreamResponse deleteEventStreamResponse =
            DeleteEventStreamResponse.builder().build();
        Mockito.doReturn(deleteEventStreamResponse).when(proxy).injectCredentialsAndInvokeV2(
            any(DeleteEventStreamRequest.class), any());
